...
SOURCES = main.c mzapo_phys.c mzapo_parlcd.c lcdframe.c menu_creator.c utils.c set_static_zoom1x.c set_static_zoom2x.c set_time.c set_continuous_change.c set_flashing.c
